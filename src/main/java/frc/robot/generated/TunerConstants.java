...
public class TunerConstants {
	...
	private static final Angle kFrontLeftEncoderOffsetRobot1 = Rotations.of(-0.121826171875); // 0.375 green robot drive
																								// rail offset V2
	private static final Angle kFrontLeftEncoderOffsetRobot2 = Rotations.of(0.27880859375); // 0.375 green robot drive
																							// rail offset V2
	...
	private static final Angle kFrontRightEncoderOffsetRobot1 = Rotations.of(-0.36865234375); // 0.39453125 green robot
																								// drive rail offset V2
	private static final Angle kFrontRightEncoderOffsetRobot2 = Rotations.of(0.05419921875); // 0.39453125 green robot
																								// drive rail offset V2
	...
	private static final Angle kBackLeftEncoderOffsetRobot1 = Rotations.of(0.399169921875); // 0.375 green robot drive
																							// rail offset V2
	private static final Angle kBackLeftEncoderOffsetRobot2 = Rotations.of(0.34765625); // 0.27490234375 green robot
																						// drive rail offset V2
	...
	private static final Angle kBackRightEncoderOffsetRobot1 = Rotations.of(-0.043701171875); // -0.206298828125 green
																								// robot drive rail
																								// offset V2
	private static final Angle kBackRightEncoderOffsetRobot2 = Rotations.of(0.0888671875); // -0.206298828125 green
																							// robot drive rail offset
																							// V2
	...
	public final static double MaxSpeed = TunerConstants.kSpeedAt12Volts.in(MetersPerSecond); // kSpeedAt12Volts desired
																								// top speed
	public final static double SlowSpeed = TunerConstants.kSlowSpeed.in(MetersPerSecond);
	public final static double MaxAngularRate = RotationsPerSecond.of(0.75)
			.in(RadiansPerSecond); // 3/4 of a rotation per second max angular velocity
	public final static double SlowAngularRate = RotationsPerSecond.of(0.5).in(RadiansPerSecond);
	...
	public static CommandSwerveDrivetrain createDrivetrain() {
		...
		SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> FrontLeft = ConstantCreator
				.createModuleConstants(
						kFrontLeftSteerMotorId, kFrontLeftDriveMotorId, kFrontLeftEncoderId, kFrontLeftEncoderOffset,
						kFrontLeftXPos, kFrontLeftYPos, kInvertLeftSide, kFrontLeftSteerMotorInverted,
						kFrontLeftEncoderInverted);

		SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> FrontRight = ConstantCreator
				.createModuleConstants(
						kFrontRightSteerMotorId, kFrontRightDriveMotorId, kFrontRightEncoderId,
						kFrontRightEncoderOffset,
						kFrontRightXPos, kFrontRightYPos, kInvertRightSide, kFrontRightSteerMotorInverted,
						kFrontRightEncoderInverted);
		SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> BackLeft = ConstantCreator
				.createModuleConstants(
						kBackLeftSteerMotorId, kBackLeftDriveMotorId, kBackLeftEncoderId, kBackLeftEncoderOffset,
						kBackLeftXPos, kBackLeftYPos, kInvertLeftSide, kBackLeftSteerMotorInverted,
						kBackLeftEncoderInverted);
		SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> BackRight = ConstantCreator
				.createModuleConstants(
