...
public class RobotContainer {
    ...
    private void configureBindings() {
       ...
       // joystick.povDown().whileTrue(Commands.sequence(s_Elevator.GroundIntake_Wait(), Commands.parallel(s_Elevator.GroundIntake().repeatedly(), Commands.sequence(s_Algae.groundIntake(), s_Algae.intake())))).onFalse(Commands.sequence(Commands.parallel(s_Algae.groundIntakeHome(),s_Elevator.L2_Wait()), s_Elevator.goToL1(), new WaitCommand(1),s_Algae.reZero()));
        ...
        joystick.povLeft().whileTrue(Commands.parallel(Commands.sequence(s_Algae.extend(), s_Algae.intake()))).onFalse(Commands.parallel(s_Shooter.stopInstant(), Commands.sequence(s_Algae.stopShooter(), s_Algae.home())));
        joystick.povRight().whileTrue(Commands.parallel(Commands.sequence(s_Algae.almostextend(), s_Algae.intake()))).onFalse(Commands.parallel(s_Shooter.stopInstant(), Commands.sequence(s_Algae.stopShooter(), s_Algae.home())));
