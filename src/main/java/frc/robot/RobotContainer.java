    ...
    private void configureBindings() {
       ...
       // joystick.leftStick().onTrue(s_Algae.intake()).onFalse(s_Algae.stopShooter());
        ...
        joystick.povDown().whileTrue(Commands.parallel(new DriveToPose(drivetrain,
                new Transform2d(Units.inchesToMeters(-33.5/2+0.75), Units.inchesToMeters(4), new Rotation2d()), joystick),s_Shooter.shoot())).onFalse(new InstantCommand(()->joystick.setRumble(RumbleType.kBothRumble, 0)).andThen(s_Shooter.stop()));
