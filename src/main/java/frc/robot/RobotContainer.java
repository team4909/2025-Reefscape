...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        joystick.povDown().whileTrue(s_Elevator.goToL1Intake().repeatedly().alongWith(s_Algae.extend().andThen(s_Algae.shoot()))).onFalse(s_Algae.holdCoral().alongWith(s_Elevator.goToL3().repeatedly()));
