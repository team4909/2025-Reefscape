...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        joystick.back().whileTrue(s_Algae.intake()).onFalse(s_Algae.home().andThen(s_Algae.stopShooter().andThen(new WaitCommand(5).alongWith(s_Elevator.goToL2().repeatedly())).andThen(s_Elevator.goToL1())));
