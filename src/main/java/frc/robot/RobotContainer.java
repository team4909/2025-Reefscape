...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        joystick.back().whileTrue(s_Algae.intake()).onFalse(s_Algae.stopShooter().andThen(s_Algae.home().alongWith(s_Elevator.goToL2().repeatedly())).andThen(new WaitCommand(5)).andThen(s_Elevator.goToL1()));
