...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        joystick.povDown().whileTrue(Commands.sequence(s_Elevator.L2_Wait(), Commands.parallel(s_Elevator.goToL2().repeatedly(), Commands.sequence(s_Algae.groundIntake(), s_Algae.intake())))).onFalse((s_Algae.home()));
