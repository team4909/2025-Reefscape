...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        joystick.back().whileTrue(s_Elevator.goToL1Intake().repeatedly().alongWith(s_Algae.intakeL1().andThen(s_Algae.shoot()))).onFalse(s_Algae.holdCoral().alongWith(s_Elevator.goToL2().repeatedly()));
        joystick.leftStick().whileTrue(s_Algae.stopShooter().andThen(s_Elevator.goToL2().repeatedly())).onFalse(s_Algae.home().andThen(s_Algae.stopShooter().andThen(new WaitCommand(5).alongWith(s_Elevator.goToL2().repeatedly()))).andThen(s_Elevator.goToL1().repeatedly()));
