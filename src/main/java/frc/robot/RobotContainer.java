...
public class RobotContainer {
  ...
  private final Climber s_Climber;
    ...
    private void configureBindings() {
        ...
        joystick.povRight().whileTrue(Commands.sequence(s_Elevator.goToL3A_wait(), Commands.parallel(Commands.sequence(s_Algae.extend(), s_Algae.intake())))).onFalse((s_Algae.home()));
