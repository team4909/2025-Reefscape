...
public class RobotContainer {
	...
	public RobotContainer() {
		...
		NamedCommands.registerCommand("L2 Algae",
				Commands.sequence(s_Elevator.goToL2A(), s_Algae.extend(), s_Algae.intake()).withTimeout(1));
		NamedCommands.registerCommand("Algae Stow",
				Commands.sequence(s_Algae.down(), s_Elevator.goToL1()).withTimeout(.1));
	...
	private void configureBindings() {
		...
		joystick.rightTrigger()
				.whileTrue(new ConditionalCommand(s_Shooter.shoot(), s_Shooter.slowShoot(), () -> s_Elevator.isAtL4()))
		...
		joystick.povLeft().onTrue(Commands.sequence(s_Elevator.goToL2A(), s_Algae.extend(), s_Algae.intake()))
				.onFalse(Commands.sequence(s_Algae.down(), s_Elevator.goToL1()));
		joystick.povRight().onTrue(Commands.sequence(s_Elevator.goToL3A(), s_Algae.extend(), s_Algae.intake()))
				.onFalse(Commands.sequence(s_Algae.down(), s_Elevator.goToL1()));
