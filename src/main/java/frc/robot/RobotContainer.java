...
public class RobotContainer {
  ...
  private final Climber s_Climber;
    ...
    private void configureBindings() {
        ...
        joystick.povLeft().whileTrue(Commands.parallel(s_Elevator.goToL2A().repeatedly(),Commands.sequence(s_Algae.extend(), s_Algae.intake()))).onFalse((s_Algae.home()));
        joystick.povRight().whileTrue(Commands.parallel(s_Elevator.goToL3A().repeatedly(),Commands.sequence(s_Algae.extend(), s_Algae.intake()))).onFalse((s_Algae.home()));
