...
public class AlgaeIOTalonFX extends SubsystemBase implements AlgaeIO {
	...
	public void updateInputs(AlgaeIOInputs inputs) {
		inputs.shooterConnected = BaseStatusSignal.refreshAll(m_shooterVoltage, m_shooterCurrent, m_shooterVelocity)
				.isOK();
		inputs.wristConnected = BaseStatusSignal
				.refreshAll(m_wristPosition, m_wristVelocity, m_wristVoltage, m_wristCurrent).isOK();
