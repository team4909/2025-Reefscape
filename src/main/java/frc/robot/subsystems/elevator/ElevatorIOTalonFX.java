...
public class ElevatorIOTalonFX extends SubsystemBase implements ElevatorIO{
    ...
    public ElevatorIOTalonFX() {
        ...
        slot0Configs.kS = 0.4; //Voltage to overcome friction
        ...
        m_rightMotor.setPosition(29 * (0.5 * (1d / (1.75100 * Math.PI)) * ( 2d / 3d ) * 12));
        // m_leftMotor.setPosition(29 * (0.5 * (1d / (1.75100 * Math.PI)) * ( 2d / 3d ) * 12));
